$(function () {
  ...
  const engLishPersonInfo = {
    ...
    infoLineSix:
      "Technology Stack: Vue, JavaScript, jQuery, WeChat MiniProgram, UniApp",
  ...
  function getVisitNum() {
    const url = "http://47.94.222.2:8088/api/getVisitNum";
    $.ajax({
      url,
      headers: {
  ...
  function addVisitNum() {
    const url = "http://47.94.222.2:8088/api/updateVisitNum";
    $.ajax({
      url,
      headers: {
        "Content-Type": "application/json",
